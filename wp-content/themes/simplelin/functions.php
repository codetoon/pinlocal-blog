...
function simplelin_scripts() {
  ...
  // Load scripts.js
  wp_enqueue_script( 'simplelin-scripts', get_template_directory_uri() . '/assets/js/scripts.js', array( 'jquery' ), '20150706', true );

  // Load sub-menu-toggle.js
  wp_enqueue_script( 'simplelin-sub-menu-toggle-script', get_template_directory_uri() . '/assets/js/sub-menu-toggle.js', array( 'jquery' ), '20150816', true );

  wp_localize_script( 'simplelin-sub-menu-toggle-script', 'screenReaderText', array(
    'expand'   => '<span class="screen-reader-text">' . __( 'expand child menu', 'simplelin' ) . '</span>',
    'collapse' => '<span class="screen-reader-text">' . __( 'collapse child menu', 'simplelin' ) . '</span>',
  ) );
